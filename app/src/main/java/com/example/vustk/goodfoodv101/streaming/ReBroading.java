...
public class ReBroading extends AppCompatActivity implements VideoRendererEventListener {

    private static final String TAG = "ReBroading";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clickPos = intent.getIntExtra("value", -1);
