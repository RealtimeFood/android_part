...
//그림 받아와서 뿌리는거 해야함
public class DetailFarm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_farm);
        ImageView detail_farm = (ImageView) findViewById(R.id.detail_farm);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(DetailFarm.this, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(DetailFarm.this, DetailProduct.class);
        ...
        Picasso.get().load(detail_image).into(detail_farm);
        ...
        return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() != null) {
                    Toast.makeText(DetailFarm.this, error.getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        };
    }
